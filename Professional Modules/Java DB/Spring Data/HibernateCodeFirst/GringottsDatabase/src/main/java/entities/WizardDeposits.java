...
public class WizardDeposits {
    ...
    public WizardDeposits(long id, String firstName, String lastName, String notes, int age, String magicWandCreator, int magicWandSize,
                          String depositGroup, LocalDateTime depositStartDate, double depositAmount, double depositInterest,
